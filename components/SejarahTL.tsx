...
export function SejarahTL() {
  const data = [
    {
      title: "± 850 Masehi",
      content: (
        <div>
          <p className="text-2xl md:text-3xl font-bold pb-5">Pembangunan</p>
          <p className=" text-xl md:text-2xl font-normal mb-8">
            ...
            Berdasarkan prasasti Siwagrha berangka tahun 856 M, bangunan suci
            ini dibangun untuk memuliakan dewa Siwa, dan nama asli bangunan ini
            ...
            bahwa saat pembangunan candi Siwagrha tengah berlangsung, dilakukan
            juga pekerjaan umum perubahan tata air untuk memindahkan aliran
            sungai di dekat candi ini. Sungai yang dimaksud adalah sungai Opak
            yang mengalir dari utara ke selatan sepanjang sisi barat kompleks
            candi Prambanan.
          </p>
        </div>
      ),
